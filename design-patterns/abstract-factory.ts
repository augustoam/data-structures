 ...
 * of the Concrete Factory's methods return an abstract product, while inside the
 ...
 * All variants of the product must impelemnt this interface
 */
 ...
 * with eact other, but proper interaction is possible only between products of
...
interface AbstractProductB {
   ...
   * same variant and this, compatible
   */
...
/**
 * The client code works with factories and produts only through abstract
 * types: AbstractFactory and AbstractProduct. This lets you pass any factory or
 * product subclass to the client code withouth breaking it
 */
